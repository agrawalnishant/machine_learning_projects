...
def explore_city_data(city_data):
    ...
    # Size of data?
    print "size: ", np.size(housing_features)
    
    # Number of features?
    print "feature count: ", housing_features.shape[1]
    
    # Minimum value?
    print "min: ", np.min(housing_prices)
    
    # Maximum Value?
    print "max: ", np.max(housing_prices)
    ...
    print "std: ", np.std(housing_prices)
